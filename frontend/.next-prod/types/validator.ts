...
// Validate ../../app/api/guidance-agent/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/guidance-agent">> = Specific
  const handler = {} as typeof import("../../app/api/guidance-agent/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
