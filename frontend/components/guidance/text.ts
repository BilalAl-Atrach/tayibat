...
export const uiText = {
  en: {
    ...
    loginToSelectGoal: "You must log in to select a goal.",
    selectGoalToAsk: "You must select a goal to ask me.",
  ...
  ar: {
    ...
    loginToSelectGoal: "يجب تسجيل الدخول لاختيار هدف صحي.",
    selectGoalToAsk: "يجب اختيار هدف صحي حتى تسألني.",
